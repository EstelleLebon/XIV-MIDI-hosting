		...
		this.fullMap = [
			{
				...
				'message': `Full backup for [Solo](${prefixurl + process.env.solo}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Solo-FULL.zip`	
			},
			{
				'zip': '/usr/src/app/src/backup/send/FULL/2-duo.zip',
				'channel': process.env.duob,
				'message': `Full backup for [Duo](${prefixurl + process.env.duo}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Duo-FULL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/FULL/3-trio.zip',
				'channel': process.env.triob,
				'message': `Full backup for [Trio](${prefixurl + process.env.trio}) channel, as of the end of ${formated_last_month}`,
			...
			},
			{
				...
				'message': `Full backup for [Quartet](${prefixurl + process.env.quartet}) channel, as of the end of ${formated_last_month}`,
			...
			},
			{
				...
				'message': `Full backup for [Quintet](${prefixurl + process.env.quintet}) channel, as of the end of ${formated_last_month}`,
			...
			},
			{
				...
				'message': `Full backup for [Sextet](${prefixurl + process.env.sextet}) channel, as of the end of ${formated_last_month}`,
			...
			},
			{
				...
				'message': `Full backup for [Septet](${prefixurl + process.env.septet}) channel, as of the end of ${formated_last_month}`,
			...
			},
			{
				...
				'message': `Full backup for [Octet](${prefixurl + process.env.octet}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Octet-FULL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/FULL/pack.zip',
				'channel': process.env.packb,
				'message': `Full backup for [Pack](${prefixurl + process.env.pack}) channel, as of the end of ${formated_last_month}`,
		...
		this.incrMap = [
			{
				...
				'channel': process.env.solob,
				'message': `Incremental backup for [Solo](${prefixurl + process.env.solo}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Solo-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/2-duo.zip',
				'channel': process.env.duob,
				'message': `Incremental backup for [Duo](${prefixurl + process.env.duo}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Duo-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/3-trio.zip',
				'channel': process.env.triob,
				'message': `Incremental backup for [Trio](${prefixurl + process.env.trio}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Trio-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/4-quartet.zip',
				'channel': process.env.quartetb,
				'message': `Incremental backup for [Quartet](${prefixurl + process.env.quartet}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Quartet-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/5-quintet.zip',
				'channel': process.env.quintetb,
				'message': `Incremental backup for [Quintet](${prefixurl + process.env.quintet}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Quintet-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/6-sextet.zip',
				'channel': process.env.sextetb,
				'message': `Incremental backup for [Sextet](${prefixurl + process.env.sextet}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Sextet-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/7-septet.zip',
				'channel': process.env.septetb,
				'message': `Incremental backup for [Septet](${prefixurl + process.env.septet}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Septet-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/8-octet.zip',
				'channel': process.env.octetb,
				'message': `Incremental backup for [Octet](${prefixurl + process.env.octet}) channel, as of the end of ${formated_last_month}`,
				'filename': `${year}-${formated_last_month}-Octet-INCREMENTAL.zip`
			},
			{
				'zip': '/usr/src/app/src/backup/send/INCR/pack.zip',
				'channel': process.env.packb,
				'message': `Incremental backup for [Pack](${prefixurl + process.env.pack}) channel, as of the end of ${formated_last_month}`,
