...
const work = {"solo" : false, "duo" : false, "trio" : false, "quartet" : false, "quintet" : false, "sextet" : false, "septet" : false, "octet" : false, "pack" : false, "editor" : false};


async function download_tool_init(channelFileMap) {
    ...
    const ZipMap = [];
    for (const channel of channelFileMap) {
...
module.exports = download_tool_init; // Export the function